      ...
      <div className="container mt-150">
        ...
        <ol className="mb-4">
          ...
          <li className="mb-2 list-items">
            ...
            <p className="paragraph-items">
              ...
              <ul>
                ...
                <li>
                  find and rank expert reviewers to assist in the evaluation of
              ...
              <ul>
                ...
                <li>
                  check for potential conflicts of interests and other relevant
                  conflicts.
                </li>
              </ul>
              <p className="sub-list-items mb-1">
          ...
          <p className="paragraph-items">
            ...
            obtained through SCIN’s publication process or obtained from
          ...
          <p className="paragraph-items">
            ...
            the Philippines, the United Kingdom, and the United States. SCIN
            takes steps, including through contracts, to ensure that the
          ...
          <ul>
            ...
            <li>
              restriction of the processing of your personal information, or to
          ...
          <p className="paragraph-items">
            ...
            . SCIN will respond to your request consistent with applicable laws.
            To protect your privacy and security, SCIN may require you to verify
