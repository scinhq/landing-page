...
const ProcessingNotices = () => {
  return (
    <>
      <SEO
        title={'SCIN'}
        siteTitle={'SCIN Processing notice'}
        description={
          ...
          <ol className="mb-4">
            ...
            <li className="mb-2 list-items">
              ...
              <div className="text-styling paragraph-items">
                ...
                manage their risks, make informed decisions, run themselves in
                ...
                <ul>
                  ...
                  <li>
                    expand understanding of who is active in specific research
                    areas;
                  </li>
                  <li>
                    find and rank expert reviewers to assist in the evaluation
                    of grant applications; and
                  </li>
                  <li>
                    flag potential conflicts of interest between prospective
                ...
                <ul>
                  ...
                  <li>
                    increase their diversity, equity, and inclusion outcomes;
                    and
                  </li>
                  <li>
                    check for potential conflicts of interests and other
                    relevant conflicts.
                  </li>
                </ul>
                <div className="sub-list-items mb-1">
                ...
                <div className="text-styling paragraph-items">
                  ...
                  help Funders with their analysis and benchmarking of their
                  grant programs.
                </div>
              </div>
            </li>
            ...
            <div className="text-styling paragraph-items">
              ...
              records, such as patent filings, and publicly available
              information, such as scholarly works and news stories. This
              information is obtained through SCIN’s publication process or
              obtained from third-party sources like publishers, funders,
              preprint servers, news services, patent offices, public
            ...
            <ul>
              ...
              <li>
                where we have a good faith belief that such disclosure is
                necessary to:
              </li>
              <ul>
                <li>
                ...
                <li>
                  protect the rights, property or safety of SCIN, our users,
                  employees or others;
                </li>
              </ul>
              <li>
                as part of a corporate transaction, such as a transfer of assets
                or an acquisition by or merger with another company.
              </li>
            </ul>
            ...
            <div className="text-styling paragraph-items">
              ...
              servers and facilities, including Canada, Ireland, the
              Netherlands, the Philippines, the United Kingdom, and the United
              States. SCIN takes steps, including through contracts, to ensure
              that the information continues to be protected wherever it is
              located in a manner consistent with the standards of protection
            ...
            <ul>
              ...
              <li>
                restriction of the processing of your personal information, or
            ...
            <div className="text-styling paragraph-items">
              ...
              . SCIN will respond to your request consistent with applicable
              laws. To protect your privacy and security, SCIN may require you
              to verify your identity. You may designate an authorized agent to
              make a request on your behalf subject to proof of identity and
              authorization.
            </div>
            ...
            <div className="text-styling paragraph-items">
              For any questions, comments, complaints, or requests regarding
              this processing notice, please contact the SCIN Data Protection
              Officer via the email at{' '}
              <a href="mailto:info@scin.io" className="text-primary">
                info@scin.io
              </a>
              . You also may lodge a complaint with the data protection
          ...
          <ol className="mb-4">
            <li className="mb-2 list-items">
              ...
              <div className="text-styling paragraph-items">
                ...
                (“Recruiters”). SCIN Publishing Inc (“SCIN”) is the controller
                of personal information provided to, or collected by or for, the
                Service.
              </div>
            </li>
            <li className="mb-2 list-items">
              ...
              <div className="text-styling paragraph-items">
                ...
                Recruiters develop and implement their recruitment strategies
                and capabilities, for example, to:
                <ul>
                  <li>
                    locate and approach researchers who might match recruitment
                    opportunities;
                  </li>
                  <li>
                    create a balanced long-list of candidates, such as with
                    respect to gender, breadth of expertise and career
                    accomplishments; and
                  </li>
                  <li>
                    compare candidates with like-for-like metrics across a range
                    of career accomplishments, demonstrating their research
                    excellence and impact, as well as skills like mentoring,
                    leadership, innovation, multidisciplinarity and social
                    engagement.
                  </li>
                </ul>
              </div>
            ...
            <div className="text-styling paragraph-items">
              ...
              through SCIN’s publication process or obtained from third-party
              sources like publishers, preprint servers, news services, patent
            ...
            <li className="mb-2 list-items">Use of personal information</li>
            <div className="text-styling paragraph-items">
              SCIN uses personal information to provide the Service to
              Recruiters. Recruiters make their own decisions as to how to use
              the personal information provided by the Service, including
              whether to interview or hire a candidate. SCIN does not make any
              decisions about an individual. Recruiters’ privacy policies and
              other notices will describe how they use personal information.{' '}
            </div>
            <li className="mb-2 list-items">Grounds for processing</li>
            <div className="text-styling paragraph-items">
              Personal information is processed on the basis that is in SCIN’s
              or others’ legitimate interests.
            </div>
            <li className="mb-2 list-items">Information recipients</li>
            <div className="text-styling paragraph-items">
              SCIN shares personal information:
            ...
            <ul>
              ...
              <li>
                where SCIN has a good faith belief that such disclosure is
                necessary to:
              </li>
              <ul>
                <li>
                ...
                <li>
                  protect the rights, property or safety of SCIN, its users,
...
export default ProcessingNotices;
