      ...
      <div className="container">
        <div className="container mt-40">
          ...
          <div className="text-styling">
            ...
            respect to your privacy. This privacy policy explains how we
          ...
          <div className="text-styling mb-3">
            This privacy policy applies to our websites, apps and other
            services, including programs and events, that refer or link to this
            privacy policy (each, a “Service”). This policy may be supplemented
            by additional privacy statements, terms or notices provided to you
            or by the Service. The SCIN publishing company that owns or
            administers the Service, as identified therein, is the primary
            controller of your personal information provided to, or collected by
            or for, the Service. For information about the handling of personal
            information contained in our Service content, please read
          ...
          <div className="text-styling">
            ...
            depends on the content and features of the Service you use and how
            you otherwise interact with us and may include:
            <ul>
              <li>
                Contact details, such as your name, email address, postal
              ...
              <li>
                ...
                as your field of study, current position, practice area and
                areas of interests, gender, ORCID ID and photo;
              </li>
              <li>
            ...
            <ul>
              <li>
                Social networks that you grant permission to the Service to
            ...
            <ul>
              ...
              <li>
                ...
                selected, URL click stream data, including date and time stamp
              ...
              <li>
                For location-aware Services, the physical location of your
                device.
              </li>
            </ul>
          ...
          We are committed to delivering a relevant and useful experience to
          you. Depending on how you interact with us and the Service, we use
          ...
          <ul>
            ...
            <li>
              ...
              operations, such as to pay royalties and license fees to
              third-party content providers, determine the effectiveness of our
              promotional campaigns, evaluate our business performance, or in
              other ways pursuant to a customer agreement.
            </li>
          </ul>
          <div className="text-styling mb-3">
          ...
          <ul>
            ...
            <li>
              Invite you to submit or review manuscripts or otherwise
            ...
            <li>
              Provide you with relevant promotional messages and other
              information about products, events and services of ours, our group
              companies and third parties such as societies and sponsors;
            </li>
            <li>
          ...
          <div className="text-styling">
            We share your personal information in the following ways and
            contexts.
          </div>
          <br />
          ...
          <br />
          <div className="text-styling">
            If you access the Service through a subscription administered by
            your institution, your personal information and certain usage data
            gathered through the Service, such as the number of items you
            downloaded, any fee-based items you accessed, and test scores, may
            be accessed by or shared with the administrators authorized by your
            institution for the purposes of usage analysis, subscription
            management, course management and testing and remediation. If your
            institution is a corporation or other business entity, additional
            usage data, such as the types of records you viewed and the number
            of searches you ran, also may be shared for the purposes of cost
            attribution and departmental budgeting. We may also disclose to your
            institution or other third parties non-personally identifiable
            information, such as anonymous usage data reports and aggregated
            information, subject to any applicable legal or contractual
            obligations.
          </div>
          <br />
          ...
          <br />
          <div className="text-styling">
            Depending on the Service provided, we share your personal
            information with our:
          </div>
          <ul>
            <li>
              Affiliates, trading names and divisions within the SICN Publishing
              that provide technology, customer service and other shared
              services functions; and/or
            </li>
            <li>
          ...
          <div className="text-styling">
            ...
            you invitations, surveys, programs or information about their
            products and services that may be of interest to you as determined
            by your choices in managing your communications preferences and
            other settings. The Service may let you post and share personal
            information, comments, messages, materials and other content. Any
            such information that you disclose publicly or in discussion fora in
            the Service may be collected and used by others, may be indexed by
          ...
          <ul>
            ...
            <li>
              Protect the rights, property or safety of SICN, our users,
              employees or others;
            </li>
          </ul>
          <div className="text-styling mt-3">
            And as part of a corporate transaction, such as a transfer of a
            journal or other assets to or an acquisition by or merger with
            another company.
          </div>
          <h2 className="mt-4">Your personal account</h2>
          <div className="text-styling">
            If you create a personal user account on SCIN Publishing, you can
            sign in with the same credentials to all other website under SCIN
          ...
          <div className="text-styling">
            If you are an administrator of an institution with a subscription to
            a Service, we will use your details to communicate with you about
            your institution’s subscription and related services. If you supply
            us contact information of your colleagues, we may include a
            reference to you when we contact those individuals with
          ...
          <div className="text-styling">
            ...
            other settings when you register with the Service, by updating your
            account features and preferences, by using the “opt-in/out” or
          ...
          <div className="text-styling">
            ...
            . We will respond to your request consistent with applicable laws.
            To protect your privacy and security, we may require you to verify
          ...
          <div className="text-styling">
            ...
            loss, theft and misuse and unauthorized access, disclosure,
            alteration and destruction through the use of appropriate technical
          ...
          <div className="text-styling">
            ...
            We take steps, including through contracts, to ensure that the
          ...
          <div className="text-styling">
            ...
            Commerce. To learn more about the Privacy Shield program, and to
            view these entities’ certification, please visit{' '}
            <a
              className="btn-link"
          ...
          <div className="text-styling">
            ...
            <ul>
              <li>
                ...
                otherwise perform a contract with you or at your request prior
              ...
              <li>
                As necessary to operate our business, protect the security of
                our systems, customers and users, detect or prevent fraud, or
                fulfill our other legitimate interests as described in the
                sections above, except where our interests are overridden by
                your privacy rights.
              </li>
            </ul>
            Where we rely on your consent to process personal information, you
            have the right to withdraw your consent at any time, and where we
            rely on legitimate interests, you may have the right to object to
            our processing.
          </div>
          <h2 className="mt-4">Changes</h2>
          <div className="text-styling">
            We will update this privacy policy from time to time. Any changes
            will be posted on this page with an updated revision date. If we
            make any material changes, we will provide notice through the
          ...
          <div className="text-styling">
            ...
            please contact the SCIN Publishing via the Email () You also may
            lodge a complaint with the data protection authority in the
            applicable jurisdiction. The data protection representative for our
            businesses that are processing personal data within the scope of
            European Union and Swiss data protection laws and established
            outside of the European Economic Area and Switzerland is SCIN
            Publishing Inc. The data protection representative for our
            businesses that are processing personal data within the scope of
            United Kingdom data protection laws and established outside of the
            United Kingdom is SCIN Publishing.
          </div>
          ...
          <div className="text-styling">
            ...
            manager online manuscript submission and peer review system. When
            you create or confirm an Editorial Manager account for a journal,
            certain personal information is required, such as your name and
            email address. Some journals may require or provide you the option
            to add other information, such as postal address, institutional
            affiliation, telephone number, or ORCID ID, as well as to
            self-identify your gender identity, race and ethnicity for
            diversity, equity and inclusion purposes.If you are a reviewer,
            workflow manager may process additional information, such as your
            subject area expertise, publication history, and review history,
            including your previous review comments, to help optimally match
            submitted manuscripts with relevant reviewers.To optimize
            performance and secure the integrity of the peer review process,
            SCIN also monitors geography-based traffic and usage data. To
            deliver workflow manager services, your data may be processed by
            affiliates and service providers that perform services such as
            website hosting and IT support.You can always manage your marketing
            communication preferences in your workflow manager account at any
            time.
          </div>
        </div>
      </div>
